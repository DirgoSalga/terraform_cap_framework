locals {
  ca008 = "CA006-Global-DataProtection-Office365-iOSenAndroid-RequireAppProtection"
}
  ...
  conditions {
    ...
    users {
      ...
      excluded_groups = concat(
        ["a8e55fcf-f8ed-43c2-bb4f-0c62edd62963", "2802b872-ccfb-4b29-a9a9-459808dfb11b"],
